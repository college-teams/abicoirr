...
#     security_groups = [aws_security_group.instance_sg.id, aws_security_group.instance_ssh.id, aws_security_group.lb_sg.id]
#   }
# }
...
resource "aws_db_instance" "mysql_db" {
  ...
  backup_retention_period = 2 # Set retention period to 7 days
